...
/*!< set mem_address to NULL_I2C_MEM_ADDR if i2c device has no        \
            internal address during read/write */
...
/**
 * @brief Read date from i2c device with 8-bit internal reg/mem address
 *
 * @param dev_handle I2C device handle
 * @param mem_address The internal 8-bit reg/mem address to read from, set to
 * NULL_I2C_MEM_ADDR if no internal address.
 * @param data_len Number of bytes to read
 * @param data Pointer to a buffer to save the data that was read
 * @return esp_err_t
...
/**
 * @brief Write date to an i2c device with 8-bit internal reg/mem address
 *
 * @param dev_handle I2C device handle
 * @param mem_address The internal 8-bit reg/mem address to write to, set to
 * NULL_I2C_MEM_ADDR if no internal address.
 * @param data_len Number of bytes to write
 * @param data Pointer to the bytes to write.
 * @return esp_err_t
...
/**
 * @brief Read one or more 16 bit integers (words) from i2c device
 *
 * @param dev_handle I2C device handle
 * @param mem_address The internal 16-bit reg/mem address to read from, set to
 * NULL_I2C_MEM_ADDR if no internal address.
 ...
 *     - ESP_ERR_TIMEOUT Operation timeout because the bus is busy.
 */
esp_err_t i2c_bus_read_word(i2c_bus_device_handle_t dev_handle,
                            uint8_t mem_address,
                            uint16_t *data);

/**
 * @brief Write one or more 16 bit integers (words) from i2c device
 *
 * @param dev_handle I2C device handle
 * @param mem_address The internal 16-bit reg/mem address to read from, set to
 * NULL_I2C_MEM_ADDR if no internal address.
 * @param data 16 bit integer data buffer
 * @return esp_err_t
 *     - ESP_OK Success
 *     - ESP_ERR_INVALID_ARG Parameter error
 *     - ESP_FAIL Sending command error, slave doesn't ACK the transfer.
 ...
 *     - ESP_ERR_TIMEOUT Operation timeout because the bus is busy.
 */
esp_err_t i2c_bus_write_word(i2c_bus_device_handle_t dev_handle,
                             uint8_t mem_address,
                             uint16_t data);
#ifdef __cplusplus
}
